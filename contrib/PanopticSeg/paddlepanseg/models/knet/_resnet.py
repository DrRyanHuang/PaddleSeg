...
# from mmcv.cnn import build_plugin_layer, build_norm_layer
# import paddle.nn.layer.norm._BatchNormBase as _BatchNorm

from base_layer import build_norm_layer, build_conv_layer
...
class Bottleneck(nn.Layer):
    ...
    def __init__(self,
        ...
        if self.with_plugins:
            assert not self.with_plugins, "Not Implement"
